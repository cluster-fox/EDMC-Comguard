...
class RequestManager:
    ...
    def __init__(self, comguard):
        ...
        self.request_thread: Thread = Thread(target=self._worker, name="comguard Request worker")
    ...
    def queue_request(self, endpoint:str, method:RequestMethod, callback:callable = None, params:dict = {}, headers:dict = {}, stream:bool = False, payload:dict|None = None, data:dict|None = None):
        ...
        headers:dict = {'User-Agent': f"{self.Comguard.plugin_name}/{self.Comguard.version}"} | headers

        self.request_queue.put(ComguardRequest(endpoint, method, callback, params, headers, stream, payload, data))
    ...
    def _worker(self) -> None:
        ...
        while True:
            ...
            request:ComguardRequest = self.request_queue.get()

            if not isinstance(request, ComguardRequest):
                Debug.logger.error(f"Queued request was not an instance of ComguardRequest")
                continue
